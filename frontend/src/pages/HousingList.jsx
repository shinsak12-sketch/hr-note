                ...
                <div style={{ position:'relative', flexShrink:0 }}>
                  ...
                  {cardMenuOpen === r.id && (
                    <div style={{ position:'absolute', right:0, top:'110%', zIndex:50, background:'var(--bg)', border:'0.5px solid var(--border)', borderRadius:10, boxShadow:'0 4px 16px rgba(0,0,0,0.12)', minWidth:150, overflow:'hidden' }}>
                      ...
                      }} style={{ display:'block', width:'100%', padding:'11px 14px', border:'none', background:'none', textAlign:'left', fontSize:13, cursor:'pointer', color:'var(--text)', fontFamily:'inherit', borderBottom:'0.5px solid var(--border)' }}>↗️ 카드공유</button>
